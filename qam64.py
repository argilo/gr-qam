...
# Title: Qam64
# Generated: Mon Feb 10 21:37:42 2014
##################################################
...
class qam64(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.interp_fir_filter_xxx_0 = filter.interp_fir_filter_ccc(2, (firdes.root_raised_cosine(0.14, samp_rate, samp_rate/2, 0.18, 200)))
...
# QT sink close method reimplementation
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.interp_fir_filter_xxx_0.set_taps((firdes.root_raised_cosine(0.14, self.samp_rate, self.samp_rate/2, 0.18, 200)))
