...
# Title: Qam64 Double
# Generated: Fri Feb 21 08:24:54 2014
##################################################
...
class qam64_double(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.interp_fir_filter_xxx_0_0 = filter.interp_fir_filter_ccc(3, (firdes.root_raised_cosine(0.07, samp_rate, samp_rate/3, 0.18, rrc_taps)))
        self.interp_fir_filter_xxx_0_0.declare_sample_delay(0)
        self.interp_fir_filter_xxx_0 = filter.interp_fir_filter_ccc(3, (firdes.root_raised_cosine(0.07, samp_rate, samp_rate/3, 0.18, rrc_taps)))
        ...
        self.blocks_packed_to_unpacked_xx_0_0 = blocks.packed_to_unpacked_bb(7, gr.GR_MSB_FIRST)
        self.blocks_packed_to_unpacked_xx_0 = blocks.packed_to_unpacked_bb(7, gr.GR_MSB_FIRST)
        self.blocks_multiply_xx_1 = blocks.multiply_vcc(1)
        self.blocks_multiply_xx_0 = blocks.multiply_vcc(1)
        self.blocks_file_source_0_0 = blocks.file_source(gr.sizeof_char*1, "/home/argilo/git/advqam64.ts", False)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, "/home/argilo/git/advqam64.ts", True)
        self.blocks_add_xx_0 = blocks.add_vcc(1)
        self.analog_sig_source_x_0_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 3000000, 1, 0)
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, -3000000, 1, 0)
        ...
        self.connect((self.qam_frame_sync_enc_bb_0_0, 0), (self.qam_trellis_enc_bb_0_0, 0))
        self.connect((self.qam_randomizer_bb_0_0, 0), (self.qam_frame_sync_enc_bb_0_0, 0))
        self.connect((self.qam_interleaver_bb_0_0, 0), (self.qam_randomizer_bb_0_0, 0))
        self.connect((self.qam_transport_framing_enc_bb_0_0, 0), (self.blocks_packed_to_unpacked_xx_0_0, 0))
        self.connect((self.blocks_packed_to_unpacked_xx_0_0, 0), (self.qam_reed_solomon_enc_bb_0_0, 0))
        self.connect((self.blocks_file_source_0_0, 0), (self.qam_transport_framing_enc_bb_0_0, 0))
        self.connect((self.qam_trellis_enc_bb_0_0, 0), (self.digital_chunks_to_symbols_xx_0_0, 0))
        self.connect((self.digital_chunks_to_symbols_xx_0_0, 0), (self.interp_fir_filter_xxx_0_0, 0))
        self.connect((self.qam_reed_solomon_enc_bb_0_0, 0), (self.qam_interleaver_bb_0_0, 0))
...
# QT sink close method reimplementation
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.interp_fir_filter_xxx_0.set_taps((firdes.root_raised_cosine(0.07, self.samp_rate, self.samp_rate/3, 0.18, self.rrc_taps)))
        self.analog_sig_source_x_0_0.set_sampling_freq(self.samp_rate)
        self.analog_sig_source_x_0.set_sampling_freq(self.samp_rate)
        self.interp_fir_filter_xxx_0_0.set_taps((firdes.root_raised_cosine(0.07, self.samp_rate, self.samp_rate/3, 0.18, self.rrc_taps)))
